...
for(var i=0;i<9;i++) { 
  // A declaração for começa declarando a variável i e inicializando-a como 0. Ela verifica se i é menor que nove, executa as instruções subsequentes e incrementa 1 a variável i após cada passagem pelo loop.
...
b_reiniciar.addEventListener('click', (event) => {
	for(var i=0;i<9;i++) {
		...
		casas[i].style.color='#2ef1ff'; //Torna o valor _ invisível
		casas[i].style.backgroundColor='#2ef1ff'; //Torna o fundo branco
	}
